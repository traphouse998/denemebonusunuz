...
def seed():
    ...
    if Site.query.count() > 0:
        ...
        return redirect(url_for("admin_panel"))
    sites_data = [
        {"name": "Betbom", "bonus_text": "500 TL Deneme + 50 Freespin", "promo_kod": "BETBOM500",
        ...
        {"name": "Epikbahis", "bonus_text": "250 TL Deneme + 30 Freespin", "promo_kod": "EPİK250",
         "affiliate_link": "https://www.denemebonuscuyuz.com", "kategori": "onerilen", "sira": 2,
         "aciklama": "Güvenilir ve hızlı ödeme yapıyor. Freespin çevrimsiz."},
        {"name": "Casinolevant", "bonus_text": "200 TL + 40 Freespin", "promo_kod": "LEVANT200",
         "affiliate_link": "https://www.denemebonuscuyuz.com", "kategori": "onerilen", "sira": 3,
         "aciklama": "Canlı casino seçeneği güçlü. Kayıp iadesi %20."},
        {"name": "Fixbet", "bonus_text": "100 TL Çevrimsiz Deneme", "promo_kod": "FIX100",
         "affiliate_link": "https://www.bedavaspin.com", "kategori": "onerilen", "sira": 4,
         "aciklama": "Küçük ama güvenilir. Çekim sorunsuz."},
        {"name": "Superbetin", "bonus_text": "150 TL + 25 Freespin", "promo_kod": "SUPER150",
         "affiliate_link": "https://www.bedavaspin.com", "kategori": "yeni", "sira": 5,
         "aciklama": "Yeni üyeler için ekstra %20 bonus kampanyası aktif."},
    ]
    for s in sites_data:
